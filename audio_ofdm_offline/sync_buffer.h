...
Buffer library to handle unsynchronized received data blocks.
Two data blocks are stored to allow correlation with sync symbol
to determine frame alignment.

Implements the data structure side of data capture and frame alignment.
